...
int main(void) {
	wc_ds_path_t *path1, *path2, *path3, *path4, *path5, *path6;

	path1 = wc_ds_path_new("/////ababa/foo/////");
	path2 = wc_ds_path_new("");
	path3 = wc_ds_path_new("/////");
	path4 = wc_ds_path_new("/////ababa/foo/qsdqsd/retert");
	path5 = wc_ds_path_new("ababa/foo/azerty/oooo/");
	path6 = wc_ds_path_new("/a/z/e/r/t/y/u/i/o/p/q/s/d/f/g/h/j/k/l/m/w/x/c/v/b/n/0/1/2/3/4/5/BOOM/7/8/9/");
