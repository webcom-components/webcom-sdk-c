...
if(PACKAGE_FLAVOUR)
	if(PACKAGE_FLAVOUR STREQUAL "debian9")
		...
		set(CPACK_DEBIAN_PACKAGE_DEPENDS  "libsystemd0, libwebsockets8, libjson-c3, libssl1.1, libev4, libuv1, libevent-2.0-5, libncurses5, libc6, ca-certificates")
		set(CPACK_SYSTEM_NAME "deb9")

	elseif(PACKAGE_FLAVOUR STREQUAL "ubuntu16.04")
		set(CPACK_GENERATOR "DEB")
		set(CPACK_DEBIAN_PACKAGE_DEPENDS  "libsystemd0, libwebsockets7, libjson-c2, libssl1.0.0, libev4, libuv1, libevent-2.0-5, libncurses5, libc6, ca-certificates")
		set(CPACK_SYSTEM_NAME "xenial")

	elseif(PACKAGE_FLAVOUR STREQUAL "ubuntu16.10")
		set(CPACK_GENERATOR "DEB")
		set(CPACK_DEBIAN_PACKAGE_DEPENDS  "libsystemd0, libwebsockets7, libjson-c3, libssl1.0.0, libev4, libuv1, libevent-2.0-5, libncurses5, libc6, ca-certificates")
		set(CPACK_SYSTEM_NAME "yakkety")

	elseif(PACKAGE_FLAVOUR STREQUAL "ubuntu17.04")
		set(CPACK_GENERATOR "DEB")
	...
	elseif(PACKAGE_FLAVOUR STREQUAL "fedora24")
		set(CPACK_GENERATOR "RPM")
		set(CPACK_RPM_PACKAGE_REQUIRES "systemd-libs, libwebsockets, json-c, openssl-libs, libev, libuv, libevent, ncurses-libs")
		set(CPACK_SYSTEM_NAME "fc24")

	elseif(PACKAGE_FLAVOUR STREQUAL "fedora25")
		set(CPACK_GENERATOR "RPM")
		set(CPACK_RPM_PACKAGE_REQUIRES "systemd-libs, libwebsockets, json-c, openssl-libs, libev, libuv, libevent, ncurses-libs")
		set(CPACK_SYSTEM_NAME "fc25")

	elseif(PACKAGE_FLAVOUR STREQUAL "fedora26")
		set(CPACK_GENERATOR "RPM")
		set(CPACK_RPM_PACKAGE_REQUIRES "systemd-libs, libwebsockets, json-c, openssl-libs, libev, libuv, libevent, ncurses-libs")
