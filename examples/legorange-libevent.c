...
void stdin_cb (evutil_socket_t fd, short revents, void *udata);
...
int main(int argc, char *argv[]) {
	...
	ctx = wc_context_new_with_libevent(
	...
	stdin_watcher = event_new(loop, STDIN_FILENO, EV_READ|EV_PERSIST, stdin_cb, ctx);
